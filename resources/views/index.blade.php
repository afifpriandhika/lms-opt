        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    {{-- <h1 data-aos="fade-up">Belajar Dimana Saja</h1> --}}
                    <h1 data-aos="fade-up">Selamat Datang di Learning Management System</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Kami menawarkan metode pembelajaran yang lebih menarik
                    </h2>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                        ...
                        <div class="content">
                            <h3>Tentang Kami</h3>
                            <h2>Kami menghadirkan platform belajar digital yang menyenangkan</h2>
                            <p>
                                Akan segera hadir platform digital yang memiliki konsep belajar yang lebih menarik
                            </p>
                            <div class="text-center text-lg-start">
                                <a href="#"
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-info">
                        ...
                        <p>Hubungi kami pada sosial media berikut ini</p>
